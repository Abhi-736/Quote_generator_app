...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        dispatch({ type: "loadv", payload: false })//passsing false as payload to isLoading variable when the fetching of data is  done
      }
      catch (err) {
        console.error(err);
      }
  ...
  const addBookmark = () => {
    ...
    //passing the quote to the builder function of third reducer as payload to push it into bookmark array
